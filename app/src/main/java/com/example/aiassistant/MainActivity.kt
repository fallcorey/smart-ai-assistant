...
class MainActivity : AppCompatActivity() {
    ...
    private fun generateAIResponse(userMessage: String): String {
        ...
        return when {
            ...
            // Показать будильники
            message.contains("покажи будильник") || message.contains("мои будильник") -> {
                alarmManager.showAlarms()
                "Открываю список будильников"
            }
            
            // Показать таймеры
            message.contains("покажи таймер") || message.contains("мои таймер") -> {
                alarmManager.showTimers()
                "Открываю список таймеров"
            }
...
Просто напишите или скажите команду!"""
    ...
    private fun handleTimerCommand(message: String): String {
        ...
        return if (duration != null) {
            alarmManager.setTimer(duration)
        } else {
